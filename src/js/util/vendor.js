...
/**
 * @class Vendor
 * @classdesc Provides methods to load external JS and CSS bundles dynamically,
 * 			  track their loading state, and prevent multiple loads of the same plugin.
 */
